namespace OpenMapper.UnitTests.Bug.NamingConventions;
...
public class RemoveNameSplitMapper : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_not_validate() => Should.Throw<OpenMapperConfigurationException>(AssertConfigurationIsValid)
...
public class DisableNamingConvention : NonValidatingSpecBase
{
    ...
    public void Should_not_use_pascal_naming_convention() =>
        new Action(Mapper.ConfigurationProvider.AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>()
...
public class When_mapping_with_lowercase_naming_conventions_two_ways_in_profiles : OpenMapperSpecBase
{
...
public class When_mapping_with_lowercase_naming_conventions_two_ways : OpenMapperSpecBase
{
    private Dario _dario;
    private Neda _neda;
