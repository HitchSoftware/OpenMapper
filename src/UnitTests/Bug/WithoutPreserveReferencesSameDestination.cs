...
public class Self_referencing_existing_destination_without_PreserveReferences : OpenMapperSpecBase
{
...
public class WithoutPreserveReferencesSameDestination : OpenMapperSpecBase
{
    public class DtoOne
    {
