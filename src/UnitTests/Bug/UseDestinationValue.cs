...
public class UseDestinationValueNullable : OpenMapperSpecBase
{
    class Source
    {
        public int? Value;
...
public class UseDestinationValue : OpenMapperSpecBase
{
...
public class DontUseDestinationValue : NonValidatingSpecBase
{
    ...
    public void Should_report_missing_constructor()
    {
        ...
        new Action(()=>Mapper.Map<Organization>(orgDto)).ShouldThrowException<OpenMapperMappingException>(
