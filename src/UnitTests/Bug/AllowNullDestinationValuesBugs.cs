...
public class When_mapping_to_an_assignable_object_with_nullable_off : OpenMapperSpecBase
{
...
public class When_AllowNullDestinationValues_is_false : OpenMapperSpecBase
{
    public class Source
    {
    }
