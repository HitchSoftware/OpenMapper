...
public class ConstructorParameterNamedType
{
    ...
    public void Should_handle_constructor_parameter_named_type()
    {
        ...
        new Action(config.AssertConfigurationIsValid).ShouldThrowException<OpenMapperConfigurationException>(ex=>ex.Errors[0].UnmappedPropertyNames[0].ShouldBe("Type"));
    }
}