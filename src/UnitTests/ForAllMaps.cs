...
public class ForAllMapsTypeConverter : OpenMapperSpecBase
{
...
public class ForAllMaps : OpenMapperSpecBase
{
...
public class ForAllMapsWithConstructors : OpenMapperSpecBase
{
    class Source
    {
    }
