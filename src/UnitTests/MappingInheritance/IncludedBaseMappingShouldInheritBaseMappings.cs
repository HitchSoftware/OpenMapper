...
public class IncludedMappingShouldInheritBaseMappings : NonValidatingSpecBase
{
    ...
    public void included_mapping_with_parameter_has_same_name_but_diffent_type_should_throw()
    {
        ...
        Assert.Throws<OpenMapperConfigurationException>(config.AssertConfigurationIsValid).Errors.Single().CanConstruct.ShouldBeFalse();
    }
}

public class OverrideDifferentMapFrom : OpenMapperSpecBase
{
    class Source
    {
    }
