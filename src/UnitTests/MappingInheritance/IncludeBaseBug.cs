...
public class Include : OpenMapperSpecBase
{
    public class From
    {
...
public class BaseNotMatching : OpenMapperSpecBase
{
    public class From
    {
        public int Value { get; set; }
...
public class BaseMatchingDifferentType : OpenMapperSpecBase
{
    public class From
    {
        public int Value { get; set; }
...
public class IgnoreBaseMatching : OpenMapperSpecBase
{
    public class From
    {
        public int Value { get; set; }
