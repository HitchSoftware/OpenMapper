...
public class IgnoreShouldBeInheritedRegardlessOfMapOrder : OpenMapperSpecBase
{
...
public class IgnoreShouldBeInherited : OpenMapperSpecBase
{
    public class BaseDomain
    {            
    }
...
public class IgnoreShouldBeInheritedWithOpenGenerics : OpenMapperSpecBase
{
...
public class IgnoreOverrideShouldBeInherited : OpenMapperSpecBase
{
    class Foo
    {
...
public class IgnoreOverrideShouldBeOverriden : OpenMapperSpecBase
{
    class Foo
    {
        public string FooText { get; set; }
...
public class IgnoreOverrideShouldBeInheritedIncludeBase : OpenMapperSpecBase
{
    class Foo
    {
        public string FooText { get; set; }
...
public class IgnoreOverrideShouldBeOverridenIncludeBase : OpenMapperSpecBase
{
    class Foo
    {
        public string FooText { get; set; }
