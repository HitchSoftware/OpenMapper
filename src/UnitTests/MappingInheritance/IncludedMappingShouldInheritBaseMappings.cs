...
public class IncludeBaseIndirectBase : OpenMapperSpecBase
{
...
public class ReadonlyCollectionPropertiesOverride : OpenMapperSpecBase
{
...
public class ReadonlyCollectionProperties : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg=>
    {
...
public class IncludedBaseMappingShouldInheritBaseMappings : NonValidatingSpecBase
{
    ...
    [Fact]
    public void include_should_allow_OpenMapper_to_select_more_specific_included_type_with_one_parameter()
    {
        var config = new MapperConfiguration(cfg =>
        {
            cfg.CreateMap<ModelObject, DtoObject>()
    ...
    [Fact]
    public void include_should_allow_OpenMapper_to_select_more_specific_included_type()
    {
        var config = new MapperConfiguration(cfg =>
        {
            cfg.CreateMap<ModelObject, DtoObject>()
