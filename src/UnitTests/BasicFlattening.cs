...
public class BasicFlattening : OpenMapperSpecBase
{
...
public class NullFlattening : OpenMapperSpecBase
{
...
public class NullTypeMapFlattening : OpenMapperSpecBase
{
...
public class FlatteningWithSourceValidation : NonValidatingSpecBase
{
    ...
    public void Should_validate() =>
        new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>().Errors.Single().UnmappedPropertyNames.Single().ShouldBe(nameof(Address.Id));
}