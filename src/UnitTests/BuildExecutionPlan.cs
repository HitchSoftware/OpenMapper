...
public class BuildExecutionPlan : OpenMapperSpecBase
{
    Model _source;
    Dto _destination;
    public class Model
...
public class When_reusing_the_execution_plan_inner_map : OpenMapperSpecBase
{
    class Source
    {
...
public class AllowNullWithMapAtRuntime : OpenMapperSpecBase
{
    class Source
    {
        public Inner Inner { get; set; }
...
public class When_reusing_the_execution_plan : OpenMapperSpecBase
{
    class Source
    {
...
public class When_reusing_the_execution_plan_existing_destination : OpenMapperSpecBase
{
    class Source
    {
        public int[] Ints { get; set; }
