...
public class When_an_extension_methods_contraints_fail : NonValidatingSpecBase
{
    ...
    [Fact]
    public void It_should_fail_validation() => new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>()
        .Errors[0].UnmappedPropertyNames[0].ShouldBe(nameof(Destination.Count));
}
public class When_an_extension_method_is_for_a_base_interface : OpenMapperSpecBase
{
    class Source : IGeneric<int>
    {
    }
...
public class When_an_extension_method_is_for_a_base_class : OpenMapperSpecBase
{
    class Source
    {
    }
...
public class When_null_is_passed_to_an_extension_method : OpenMapperSpecBase
{
    public class Foo
    {
...
public class When_extension_method_returns_value_type : OpenMapperSpecBase
{
...
public class When_extension_method_returns_object : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_extension_contains_LINQ_methods : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_disabling_method_maping : NonValidatingSpecBase
{
    ...
    {
        new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>().Errors[0]
...
public class When_a_static_method_has_first_parameter_null : OpenMapperSpecBase
{
    class FirstName
    {
        public string Name;
