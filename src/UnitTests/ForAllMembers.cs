namespace OpenMapper.UnitTests.ForAllMembers;
public class When_conditionally_applying_a_resolver_globally : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_conditionally_applying_a_resolver_per_profile : OpenMapperSpecBase
{
    public class Source
    {
        public DateTime SomeDate { get; set; }
...
public class ForAllPropertyMaps_ConvertUsing : OpenMapperSpecBase
{
    public class Well
    {
