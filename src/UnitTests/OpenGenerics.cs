...
public class ForPathGenericsSource : OpenMapperSpecBase
{
    class Source<T>
    {
...
public class ForPathGenerics : OpenMapperSpecBase
{
    class Source<T>
    {
        public InnerSource Inner;
...
public class ReadonlyPropertiesGenerics : OpenMapperSpecBase
{
    class Source
    {
        public InnerSource Inner;
...
public class ConstructorValidationGenerics : NonValidatingSpecBase
{
    ...
    {
        var error = new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>().Errors.Single();
        error.CanConstruct.ShouldBeFalse();
        error.UnmappedPropertyNames.Single().ShouldBe("OtherValue");
    }
}
public class SealGenerics : OpenMapperSpecBase
{
...
public class OpenGenerics_With_Struct : OpenMapperSpecBase
{
    public struct Id<T>
    {
    }
...
public class OpenGenerics_With_Base_Generic : OpenMapperSpecBase
{
    public class Foo<T>
    {
...
public class GenericMapsAsNonGeneric : OpenMapperSpecBase
{
    class Source
    {
        public int Value;
...
public class GenericMapsPriority : OpenMapperSpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericMapWithUntypedMap : OpenMapperSpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericValueResolverTypeMismatch : OpenMapperSpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericValueResolver : OpenMapperSpecBase
{
    class Destination
    {
        public string MyKey;
...
public class GenericMemberValueResolver : OpenMapperSpecBase
{
    class Destination
    {
        public string MyKey;
...
public class RecursiveOpenGenerics : OpenMapperSpecBase
{
...
public class OpenGenericsValidation : NonValidatingSpecBase
{
    ...
    public void Should_report_unmapped_property()
    {
        new Action(Configuration.AssertConfigurationIsValid)
            .ShouldThrow<OpenMapperConfigurationException>()
...
public class OpenGenericsProfileValidation : OpenMapperSpecBase
{
    public class Source<T>
    {
        public T[] Value { get; set; }
...
public class OpenGenerics_With_MemberConfiguration : OpenMapperSpecBase
{
    public class Foo<T>
    {
        public int A { get; set; }
...
public class OpenGenerics_With_UntypedMapFrom : OpenMapperSpecBase
{
    public class Foo<T>
    {
        public T Value1 { get; set; }
...
public class OpenGenerics_With_UntypedMapFromStructs : OpenMapperSpecBase
{
