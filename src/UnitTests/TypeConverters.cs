namespace OpenMapper.UnitTests.CustomMapping;
public class StringToEnumConverter : OpenMapperSpecBase
{
    class Source
    {
...
public class NullableConverter : OpenMapperSpecBase
{
...
public class MissingConverter : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(c =>
    {
    ...
    public void Should_report_the_missing_converter()
    {
        new Action(()=>Mapper.Map<int, int>(0))
            .ShouldThrowException<OpenMapperMappingException>(e=>e.Message.ShouldBe("Cannot create an instance of type OpenMapper.ITypeConverter`2[System.Int32,System.Int32]"));
    }
}

public class DecimalAndNullableDecimal : OpenMapperSpecBase
{
...
public class When_converting_to_string : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_specifying_type_converters_for_object_mapper_types : OpenMapperSpecBase
{
    class Source
    {
...
public class When_specifying_type_converters : OpenMapperSpecBase
{
    ...
    protected override void Because_of()
    {
        var source = new Source
        {
            Value1 = "5",
            Value2 = "01/01/2000",
            Value3 = "OpenMapper.UnitTests.CustomMapping.When_specifying_type_converters+Destination"
        };
...
public class When_specifying_type_converters_on_types_with_incompatible_members : OpenMapperSpecBase
{
...
public class When_specifying_a_non_generic_type_converter_for_a_non_generic_configuration : OpenMapperSpecBase
{
    private Destination _result;
