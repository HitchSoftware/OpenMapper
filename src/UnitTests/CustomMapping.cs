...
public class When_implementing_multiple_IValueResolver_interfaces : OpenMapperSpecBase
{
...
public class When_using_IMemberResolver_derived_interface : OpenMapperSpecBase
{
...
public class OpenGenericMapForMember : OpenMapperSpecBase
{
...
public class IntToNullableIntConverter : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_throwing_NRE_from_MapFrom_value_types : OpenMapperSpecBase
{
...
public class When_throwing_NRE_from_MapFrom : OpenMapperSpecBase
{
    class Source
    {
    }
...
public class When_using_value_with_mismatched_properties : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_custom_resolving_mismatched_properties : OpenMapperSpecBase
{
    Destination _destination;
    static Guid _guid = Guid.NewGuid();
...
public class When_resolve_throws : NonValidatingSpecBase
{
    ...
    {
        new Action(()=>Mapper.Map<Destination>(new Source())).ShouldThrowException<OpenMapperMappingException>(e=>e.InnerException.ShouldBe(_ex));
    }
}

public class When_mapping_different_types_with_explicit_value : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_different_types_with_ResolveUsing : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_from_object_to_string_with_use_value : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_from_object_to_string : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_to_a_dto_member_with_custom_mapping : OpenMapperSpecBase
{
...
public class When_using_a_custom_resolver_for_a_child_model_property_instead_of_the_model : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_reseting_a_mapping_to_use_a_resolver_to_a_different_member : OpenMapperSpecBase
{
...
public class When_reseting_a_mapping_from_a_property_to_a_method : OpenMapperSpecBase
{
    private Dest _result;
...
public class When_specifying_a_custom_constructor_and_member_resolver : OpenMapperSpecBase
{
...
public class When_specifying_a_member_resolver_and_custom_constructor : OpenMapperSpecBase
{
    private Source _source;
    private Destination _dest;
...
public class When_specifying_a_custom_constructor_function_for_custom_converters : OpenMapperSpecBase
{
...
public class When_specifying_a_custom_translator_with_mismatched_properties : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_configuring_a_global_constructor_function_for_resolvers : OpenMapperSpecBase
{
    private Destination _result;
...
public class When_custom_resolver_requests_property_to_be_ignored : OpenMapperSpecBase
{
...
public class When_using_inheritance_with_value_resoluvers : OpenMapperSpecBase
{
...
public class When_specifying_member_and_member_resolver_using_string_property_names : OpenMapperSpecBase
{
    private Destination _result;
...
public class When_destination_property_does_not_have_a_setter : OpenMapperSpecBase
{
    private Source _source;
    private Destination _dest;
...
public class When_destination_property_does_not_have_a_getter : OpenMapperSpecBase
{
    private Source _source;
    private Destination _dest;
...
public class When_destination_type_requires_a_constructor : OpenMapperSpecBase
{
...
public class When_mapping_from_a_constant_value : OpenMapperSpecBase
{
    private Dest _dest;
...
public class When_mapping_from_one_type_to_another : OpenMapperSpecBase
{
    private Dest _dest;
    ...
    public class Dest
    {
        // OpenMapper tries to map source to this constructor's parameter,
