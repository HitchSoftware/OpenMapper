...
namespace OpenMapper.UnitTests.Tests;
...
public class When_using_a_custom_source_naming_convention : OpenMapperSpecBase
{
...
public class When_using_a_custom_destination_naming_convention : OpenMapperSpecBase
{
    private class Source
    {
