...
public class CyclesWithInheritance : OpenMapperSpecBase
{
    class FlowChart
    {
...
public class When_the_source_has_cyclical_references_with_dynamic_map : OpenMapperSpecBase
{
...
public class When_the_same_map_is_used_again : OpenMapperSpecBase
{
    class Source
    {
...
public class When_the_source_has_cyclical_references : OpenMapperSpecBase
{
...
public class When_the_source_has_cyclical_references_with_ForPath : OpenMapperSpecBase
{
    public class Article
    {
        public int Id { get; set; }
...
public class When_the_source_has_cyclical_references_with_ignored_ForPath : OpenMapperSpecBase
{
    public class Supplier
    {
        public int Id { get; set; }
...
public class When_mapping_to_a_destination_with_a_bidirectional_parent_one_to_many_child_relationship : OpenMapperSpecBase
{
...
//public class When_mapping_to_a_destination_with_a_bidirectional_parent_one_to_many_child_relationship_using_CustomMapper_StackOverflow : OpenMapperSpecBase
//{
//    private ParentDto _dto;
...
public class When_mapping_to_a_destination_with_a_bidirectional_parent_one_to_one_child_relationship : OpenMapperSpecBase
{
    private FooDto _dto;
...
public class When_mapping_to_a_destination_containing_two_dtos_mapped_from_the_same_source : OpenMapperSpecBase
{
...
public class When_mapping_with_a_bidirectional_relationship_that_includes_arrays : OpenMapperSpecBase
