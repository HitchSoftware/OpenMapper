namespace OpenMapper.UnitTests.ConfigurationValidation;
public class When_testing_a_dto_with_mismatched_member_names_and_mismatched_types : OpenMapperSpecBase
{
    public class Source
    {
        ...
        new Action(AssertConfigurationIsValid)
            ...
            .ShouldSatisfyAllConditions(
                ...
                aex => aex.InnerExceptions[0]
                    .ShouldBeOfType<OpenMapperConfigurationException>()
                    .ShouldSatisfyAllConditions(
...
public class When_testing_a_dto_with_mismatches_in_multiple_children : OpenMapperSpecBase
{
    public class Source
    {
        public Type Foo { get; set; }
...
public class ConstructorMappingValidation : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_fail_validation() => new Action(AssertConfigurationIsValid).ShouldThrowException<OpenMapperConfigurationException>(ex=>
        ex.MemberMap.ToString().ShouldBe("Void .ctor(ComplexType), parameter myComplexMember"));
}

public class When_using_a_type_converter : OpenMapperSpecBase
{
    public class A
    {
...
public class When_using_a_type_converter_class : OpenMapperSpecBase
{
    public class A
    {
        public string Foo { get; set; }
...
public class When_skipping_validation : NonValidatingSpecBase
{
    ...
    {
        typeof(OpenMapperConfigurationException).ShouldNotBeThrownBy(() => Mapper.ConfigurationProvider.AssertConfigurationIsValid());
    }
}
...
public class When_constructor_does_not_match : NonValidatingSpecBase
{
    ...
    {
        typeof(OpenMapperConfigurationException).ShouldBeThrownBy(AssertConfigurationIsValid);
    }
}

public class When_constructor_does_not_match_ForCtorParam : OpenMapperSpecBase
{
    public class Source
    {
    }
...
public class When_constructor_partially_matches_and_ctor_param_configured : NonValidatingSpecBase
{
    ...
    public void Should_throw()
    {
        typeof(OpenMapperConfigurationException).ShouldNotBeThrownBy(AssertConfigurationIsValid);
    }
}
...
public class ResolversWithSourceValidation : OpenMapperSpecBase
{
    class Source
    {
...
public class NonMemberExpressionWithSourceValidation : NonValidatingSpecBase
{
    ...
    public void Should_be_ignored() => new Action(AssertConfigurationIsValid)
        .ShouldThrow<OpenMapperConfigurationException>().Errors[0].UnmappedPropertyNames[0].ShouldBe(nameof(Source.Value));
}
...
public class When_testing_a_dto_with_fully_mapped_and_custom_matchers : OpenMapperSpecBase
{
    public class ModelObject
    {
        public string Foo { get; set; }
...
public class When_testing_a_dto_with_member_type_mapped_mappings : OpenMapperSpecBase
{
    private OpenMapperConfigurationException _exception;
    ...
    protected override void Because_of()
    {
        ...
        catch (OpenMapperConfigurationException ex)
        {
            _exception = ex;
        }
    }
...
public class When_testing_a_dto_with_matched_members_but_mismatched_types_that_are_ignored : OpenMapperSpecBase
{
    private OpenMapperConfigurationException _exception;
...
public class When_testing_a_dto_in_a_specfic_profile : NonValidatingSpecBase
{
    ...
    public void Should_ignore_bad_dtos_in_other_profiles() =>
        typeof(OpenMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid("Good"));
    [Fact]
...
public class When_configuring_a_resolver : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
...
public class ObjectPropertyAndNestedTypes : OpenMapperSpecBase
{
    ...
    [Fact]
    public void Should_fail_validation() => new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>().MemberMap.DestinationName.ShouldBe(nameof(RootLevelDto.SecondLevel));
}