...
public class ForCtorParamValidation : OpenMapperSpecBase
{
...
public class ForCtorParam_MapFrom_String : OpenMapperSpecBase
{
...
public class ForCtorParam_MapFrom_ProjectTo : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_configuring__non_generic_ctor_param_members : OpenMapperSpecBase
{
    public class Source
    {
    ...
    public void Should_throw_on_nonexistent_parameter()
    {
        ...
        configuration.ShouldThrowException<OpenMapperConfigurationException>(exception =>
        {
