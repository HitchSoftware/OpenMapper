...
public class UnsupportedCollection : OpenMapperSpecBase
{
    class Source
    {
    ...
    [Fact]
    public void ThrowsAtMapTime() => new Action(()=>Map<Destination>(new Source())).ShouldThrow<OpenMapperMappingException>()
...
public class When_mapping_interface_to_interface_readonly_set : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_mapping_hashset_to_interface_readonly_set : OpenMapperSpecBase
{
    public class Source
    {
...
public class NonPublicEnumeratorCurrent : OpenMapperSpecBase
{
    class Source
    {
...
public class ImmutableCollection : OpenMapperSpecBase
{
    class Source
    {
        public string Value { get; set; }
...
public class AssignableCollection : OpenMapperSpecBase
{
    class Source
    {
        public string Value { get; set; }
...
public class RecursiveCollection : OpenMapperSpecBase
{
    class Source
    {
        public string Value { get; set; }
...
public class AmbigousMethod : OpenMapperSpecBase
{
    public class Source
    {
        public string Value { get; set; }
...
public class Enumerator_disposable_at_runtime_class : OpenMapperSpecBase
{
...
public class Enumerator_non_disposable_struct : OpenMapperSpecBase
{
    class CustomList<T> : List<T>
    {
        private CustomEnumerator _enumerator;
...
public class Enumerator_dispose : OpenMapperSpecBase
{
    class CustomList<T> : List<T>
    {
        private CustomEnumerator _enumerator;
...
public class Enumerator_dispose_exception : OpenMapperSpecBase
{
    class CustomList<T> : List<T>
    {
        private CustomEnumerator _enumerator;
...
public class Enumerator_dispose_struct : OpenMapperSpecBase
{
    class CustomList<T> : List<T>
    {
        private CustomEnumerator _enumerator;
...
public class Enumerator_dispose_exception_struct : OpenMapperSpecBase
{
    class CustomList<T> : List<T>
    {
        private CustomEnumerator _enumerator;
...
public class When_mapping_to_existing_observable_collection : OpenMapperSpecBase
{
...
public class When_mapping_to_member_typed_as_IEnumerable : OpenMapperSpecBase
{
...
public class When_mapping_to_existing_collection_typed_as_IEnumerable : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(_=>{ });
...
public class When_mapping_to_readonly_property_as_IEnumerable_and_existing_destination : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_mapping_to_readonly_collection_without_setter : OpenMapperSpecBase
{
    public class Source
    {
    ...
    public void Should_fail() => new Action(() => Mapper.Map(new Source(), new Destination()))
        .ShouldThrow<OpenMapperMappingException>()
        .InnerException.ShouldBeOfType<NotSupportedException>()
        .Message.ShouldBe("Collection is read-only.");
}

public class When_mapping_to_readonly_property_UseDestinationValue : OpenMapperSpecBase
{
    public class Source
    {
        private readonly List<string> _myCollection = new List<string> { "one", "two" };
...
public class When_mapping_to_readonly_property_as_IEnumerable : OpenMapperSpecBase
{
    public class Source
    {
        private readonly List<string> _myCollection = new List<string> { "one", "two" };
...
public class When_mapping_from_struct_collection : OpenMapperSpecBase
{
...
public class When_mapping_to_custom_collection_type : OpenMapperSpecBase
{
...
public class When_mapping_to_unknown_collection_type : NonValidatingSpecBase
{
    ...
    {
        new Action(AssertConfigurationIsValid).ShouldThrowException<OpenMapperConfigurationException>(ex =>
        {
...
public class When_mapping_collections_with_inheritance : OpenMapperSpecBase
{
    public class Source
    {
        public IEnumerable<SourceItem> Items { get; set; }
...
public class When_passing_a_not_empty_collection : OpenMapperSpecBase
{
...
public class When_mapping_collections_with_structs : OpenMapperSpecBase
{
    BarDTO _destination;
...
public class When_mapping_from_ICollection_types_but_implementations_are_different : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_mapping_enumerable_to_array : OpenMapperSpecBase
{
    public class Source
    {
