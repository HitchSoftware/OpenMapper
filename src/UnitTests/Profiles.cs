namespace OpenMapper.UnitTests
{
    namespace Profiles
    {
        ...
        public class When_configuring_a_profile_through_a_profile_subclass : OpenMapperSpecBase
        {
            private Dto _result;
        ...
        public class When_disabling_constructor_mapping_with_profiles : OpenMapperSpecBase
        {
            private B _b;
