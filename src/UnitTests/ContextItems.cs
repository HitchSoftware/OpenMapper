...
public class Context_try_get_items : OpenMapperSpecBase
{
...
public class When_mapping_with_contextual_values_wrong_overload : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
    ...
    {
        new Action(() => Mapper.Map<Source, Dest>(new Source { Value = 5 })).ShouldThrowException<OpenMapperMappingException>(ex =>
        {
...
public class When_mapping_nested_context_items : OpenMapperSpecBase
{
    public class Door { }
