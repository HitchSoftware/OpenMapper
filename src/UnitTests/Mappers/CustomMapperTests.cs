...
public class When_adding_a_custom_mapper : OpenMapperSpecBase
{
...
public class When_adding_a_simple_custom_mapper : OpenMapperSpecBase
{
    ClassB _destination;
...
public class When_adding_an_object_based_custom_mapper : OpenMapperSpecBase
{
