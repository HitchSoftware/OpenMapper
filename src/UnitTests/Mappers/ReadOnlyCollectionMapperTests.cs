namespace OpenMapper.UnitTests.Mappers
{
    ...
    {
        public class When_mapping_to_interface_readonly_collection : OpenMapperSpecBase
        {
            public class Source
            {
        ...
        public class When_mapping_to_concrete_readonly_collection : OpenMapperSpecBase
        {
            public class Source
            {
        ...
        public class When_mapping_to_interface_readonly_list : OpenMapperSpecBase
        {
            public class Source
            {
