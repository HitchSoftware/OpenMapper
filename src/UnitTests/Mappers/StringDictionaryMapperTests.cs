...
public class When_mapping_from_StringDictionary_multiple_matching_keys : NonValidatingSpecBase
{
    ...
    {
        Should.Throw<OpenMapperMappingException>(() =>
        {
            Mapper.Map<Destination>(_source);
        }).InnerException.ShouldBeOfType<OpenMapperMappingException>().Types.ShouldBe(new TypePair(typeof(IDictionary<string, object>), typeof(Destination)));
    }
}
...
public class When_mapping_from_StringDictionary_to_existing_destination : OpenMapperSpecBase
{
...
public class When_mapping_from_StringDictionary_to_abstract_type : OpenMapperSpecBase
{
    public abstract class SomeBase
    {
        protected int _x = 100;
    ...
    public void Should_throw()
    {
        new Action(() => Mapper.Map<SomeBase>(new StringDictionary()))
            .ShouldThrowException<OpenMapperMappingException>(ex =>
