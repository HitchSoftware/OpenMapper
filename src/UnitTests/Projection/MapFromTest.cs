namespace OpenMapper.UnitTests.Projection.MapFromTest;
...
public class When_mapping_from_and_source_member_both_can_work : OpenMapperSpecBase
{
    Dto _destination;
...
public class When_mapping_from_chained_properties : OpenMapperSpecBase
{
    class Model
    {
...
public class When_mapping_from_private_method : OpenMapperSpecBase
{
    class Model
    {
        public InnerModel Inner { get; set; }
