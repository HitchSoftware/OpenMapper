namespace OpenMapper.UnitTests.InterfaceMapping;
public class InterfaceWithObjectProperty : OpenMapperSpecBase
{
...
public class InterfaceInheritance : OpenMapperSpecBase
{
...
public class MapToInterface : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_throw() => new Action(()=>Mapper.Map<IEnumerable<object>>(new object())).ShouldThrow<OpenMapperMappingException>().Message.ShouldStartWith(
        "Cannot create interface System.Collections.Generic.IEnumerable`1[System.Object]");
}
public class GenericsAndInterfaces : OpenMapperSpecBase
{
...
public class When_mapping_generic_interface : OpenMapperSpecBase
{
...
public class When_mapping_an_interface_with_getter_only_member : OpenMapperSpecBase
{
    interface ISource
    {
        int Id { get; set; }
...
public class When_mapping_to_existing_object_through_interfaces : OpenMapperSpecBase
{
...
public class When_mapping_an_interface_to_an_abstract_type : OpenMapperSpecBase
{
...
public class When_mapping_a_concrete_type_to_an_interface_type : OpenMapperSpecBase
{
...
public class When_mapping_an_interface_type_to_a_concrete_type_and_reverse : OpenMapperSpecBase
{
    public interface ISource
    {
        int Value { get; set; }
    ...
    {
        Should.Throw<OpenMapperMappingException>(() => Mapper.Map<Destination, ISource>(new Destination {Value = 5}))
            .Message.ShouldStartWith("Cannot create interface " + typeof(ISource).FullName);
    }
}

public class When_mapping_an_interface_type_to_an_interface_type_and_reverse : OpenMapperSpecBase
{
    public interface ISource
    {
        int Value { get; set; }
...
public class When_mapping_a_concrete_type_to_an_interface_type_and_reverse : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_mapping_a_concrete_type_to_an_interface_type_that_derives_from_INotifyPropertyChanged : OpenMapperSpecBase
{
    private IDestination _result;
...
public class When_mapping_a_derived_interface_to_an_derived_concrete_type : OpenMapperSpecBase
{
...
public class When_mapping_a_derived_interface_to_an_derived_concrete_type_with_readonly_interface_members : OpenMapperSpecBase
{
    private Destination _result = null;
...
public class When_mapping_to_a_type_with_explicitly_implemented_interface_members : OpenMapperSpecBase
{
...
public class MappingToInterfacesWithPolymorphism : OpenMapperSpecBase
{
