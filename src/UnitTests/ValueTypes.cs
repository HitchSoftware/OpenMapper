namespace OpenMapper.UnitTests.ValueTypes;

public class When_value_types_are_the_source_of_map_cycles : OpenMapperSpecBase
{
...
public class When_value_types_are_the_source_of_map_cycles_with_PreserveReferences : OpenMapperSpecBase
{
    public struct Source
    {
        public InnerSource Value { get; set; }
...
public class When_destination_type_is_a_value_type : OpenMapperSpecBase
{
...
public class When_source_struct_config_has_custom_mappings : OpenMapperSpecBase
{
...
public class When_destination_type_is_a_nullable_value_type : OpenMapperSpecBase
{
    private Destination _destination;
...
public class ValueTypeDestinationPreserveReferences : OpenMapperSpecBase
{
