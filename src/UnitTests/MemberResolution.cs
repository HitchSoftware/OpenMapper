namespace OpenMapper.UnitTests.MemberResolution;

public class When_multiple_source_members_match_postfix : OpenMapperSpecBase
{
    class Order
    {
...
public class When_multiple_source_members_match : OpenMapperSpecBase
{
    class Source
    {
...
public class When_mapping_derived_classes_in_arrays : OpenMapperSpecBase
{
...
public class When_mapping_derived_classes : OpenMapperSpecBase
{
    private DtoObject _result;
...
public class When_mapping_derived_classes_from_intefaces_to_abstract : OpenMapperSpecBase
{
    private DtoObject[] _result;
...
public class When_mapping_derived_classes_as_property_of_top_object : OpenMapperSpecBase
{
...
public class When_mapping_dto_with_only_properties : OpenMapperSpecBase
{
...
public class When_mapping_dto_with_only_fields : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_mapping_dto_with_fields_and_properties : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_ignoring_a_dto_property_during_configuration : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_mapping_dto_with_get_methods : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_mapping_a_dto_with_names_matching_properties : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_mapping_with_a_dto_subtype : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_mapping_a_dto_with_a_set_only_property_and_a_get_method : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_mapping_using_a_custom_member_mappings : OpenMapperSpecBase
{
    private ModelDto _result;
...
public class When_mapping_using_custom_member_mappings_without_generics : OpenMapperSpecBase
{
...
public class When_mapping_to_a_top_level_camelCased_destination_member : OpenMapperSpecBase
{
...
public class When_mapping_to_a_self_referential_object : OpenMapperSpecBase
{
...
public class When_mapping_to_types_in_a_non_generic_manner : OpenMapperSpecBase
{
    private Destination _result;
...
public class When_matching_source_and_destination_members_with_underscored_members : OpenMapperSpecBase
{
...
public class When_source_members_configured_in_a_root_profile_contain_prefixes : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_source_members_contain_prefixes : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_source_members_contain_prefixes_with_lowercase : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_source_members_contain_postfixes_with_lowercase : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_source_members_configured_in_a_root_profile_contain_postfixes_and_prefixes : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_source_members_contain_postfixes_and_prefixes : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_source_member_names_match_with_underscores : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_recognizing_explicit_member_aliases : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_destination_members_contain_prefixes : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_destination_type_has_private_members : OpenMapperSpecBase
{
