namespace OpenMapper.UnitTests
{
    ...
    {
        public class BasicTransforming : OpenMapperSpecBase
        {
            public class Source
            {
        ...
        public class StackingTransformers : OpenMapperSpecBase
        {
            public class Source
            {
                public string Value { get; set; }
        ...
        public class DifferentProfiles : OpenMapperSpecBase
        {
            public class Source
            {
                public string Value { get; set; }
        ...
        public class StackingRootConfigAndProfileTransform : OpenMapperSpecBase
        {
            public class Source
            {
                public string Value { get; set; }
        ...
        public class TransformingValueTypes : OpenMapperSpecBase
        {
            public class Source
            {
        ...
        public class StackingRootAndProfileAndMemberConfig : OpenMapperSpecBase
        {
            public class Source
            {
                public string Value { get; set; }
        ...
        public class StackingTypeMapAndRootAndProfileAndMemberConfig : OpenMapperSpecBase
        {
            public class Source
            {
                public string Value { get; set; }
    ...
    public class TransformingInheritance : OpenMapperSpecBase
    {
    ...
    public class TransformingInheritanceForMember : OpenMapperSpecBase
    {
        public class SourceBase
        {
            public string Value { get; set; }
    ...
    public class TransformingNullable : OpenMapperSpecBase
    {
        public class Source
        {
            public int Value { get; set; }
    ...
    public class NonGenericMemberTransformer : OpenMapperSpecBase
    {
        public class Source
        {
            public string Value { get; set; }
        ...
        public class ConstructorTransforming : OpenMapperSpecBase
        {
            public class Source
            {
                public string Value { get; set; }
