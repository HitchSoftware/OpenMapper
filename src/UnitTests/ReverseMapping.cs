...
public class ReverseMapWithStaticField : OpenMapperSpecBase
{
    class Source
    {
...
public class InvalidReverseMap : NonValidatingSpecBase
{
    ...
    public void Should_report_the_error()
    {
        new Action(AssertConfigurationIsValid)
            .ShouldThrowException((OpenMapperConfigurationException ex) =>
            {
...
public class MapFromReverseResolveUsing : OpenMapperSpecBase
{
    public class Source
    {
...
public class MethodsWithReverse : OpenMapperSpecBase
{
    class Order
    {
...
public class ReverseForPath : OpenMapperSpecBase
{
    public class Order
    {
...
public class ReverseMapFrom : OpenMapperSpecBase
{
    public class Order
    {
        public CustomerHolder CustomerHolder { get; set; }
...
public class ReverseMapFromNamingConvention : OpenMapperSpecBase
{
...
public class ReverseMapFromSourceMemberName : OpenMapperSpecBase
{
    public class Source
    {
...
public class ReverseDefaultFlatteningWithIgnoreMember : OpenMapperSpecBase
{
    public class Order
    {
        public CustomerHolder Customerholder { get; set; }
...
public class ReverseDefaultFlattening : OpenMapperSpecBase
{
    public class Order
    {
        public CustomerHolder Customerholder { get; set; }
...
public class ReverseMapConventions : OpenMapperSpecBase
{
...
public class When_validating_only_against_source_members_and_source_matches : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_validating_only_against_source_members_and_unmatching_source_members_are_manually_mapped : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_validating_only_against_source_members_and_unmatching_source_members_are_manually_mapped_with_resolvers : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_reverse_mapping_open_generics : OpenMapperSpecBase
{
...
public class When_reverse_mapping_open_generics_with_MapFrom : OpenMapperSpecBase
{
    public class Source<T>
    {
        public T Value { get; set; }
...
public class When_validating_reverse_mapping_classes_with_missing_properties : OpenMapperSpecBase
{
    public class Source
    {
