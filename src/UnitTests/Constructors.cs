namespace OpenMapper.UnitTests.Constructors;
public class RecordConstructorValidation : OpenMapperSpecBase
{
    ...
    [Fact]
    public void Validate() => new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>().Message.
        ShouldContainWithoutWhitespace("When mapping to records, consider using only public constructors.");
}
public class RecordConstructorValidationForCtorParam : OpenMapperSpecBase
{
...
public class ConstructorValidation : OpenMapperSpecBase
{
    class Source
    {
    }
...
public class Nullable_enum_default_value : OpenMapperSpecBase
{
...
public class Nullable_enum_default_value_null : OpenMapperSpecBase
{
    public class Source
    {
    }
...
public class Nullable_enum_default_value_not_null : OpenMapperSpecBase
{
    public class Source
    {
    }
...
public class Dynamic_constructor_mapping : OpenMapperSpecBase
{
...
public class Constructor_mapping_without_preserve_references : OpenMapperSpecBase
{
...
public class Preserve_references_with_constructor_mapping : OpenMapperSpecBase
{
    public class ParentDTO
    {
        public ChildDTO First => Children[0];
...
public class When_construct_mapping_a_struct_with_string : OpenMapperSpecBase
{
...
public class When_construct_mapping_a_struct : OpenMapperSpecBase
{
    public class Dto
    {
...
public class When_mapping_to_an_abstract_type : OpenMapperSpecBase
{
    class Source
    {
        public int Value { get; set; }
...
public class When_a_constructor_with_extra_parameters_doesnt_match : OpenMapperSpecBase
{
...
public class When_renaming_class_constructor_parameter : OpenMapperSpecBase
{
...
public class When_constructor_matches_with_prefix_and_postfix : OpenMapperSpecBase
{
...
public class When_constructor_matches_with_destination_prefix_and_postfix : OpenMapperSpecBase
{
    PersonDto _destination;
...
public class When_constructor_matches_but_is_overriden_by_ConstructUsing : OpenMapperSpecBase
{
    PersonDto _destination;
...
public class When_constructor_is_match_with_default_value : OpenMapperSpecBase
{
    PersonDto _destination;
...
public class When_constructor_is_partial_match_with_value_type : OpenMapperSpecBase
{
...
public class When_constructor_is_partial_match : OpenMapperSpecBase
{
    GeoCoordinate _destination;
...
public class When_constructor_matches_but_the_destination_is_passed : OpenMapperSpecBase
{
...
public class When_mapping_through_constructor_and_destination_has_setter : OpenMapperSpecBase
{
    public class Source
    {
        public int MyTypeId { get; set; }
...
public class When_mapping_an_optional_GUID_constructor : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_a_constructor_parameter_from_nested_members : OpenMapperSpecBase
{
...
public class When_the_destination_has_a_matching_constructor_with_optional_extra_parameters : OpenMapperSpecBase
{
    private Destination _destination;
...
public class When_mapping_constructor_argument_fails : NonValidatingSpecBase
{
    ...
    {
        var ex = new Action(AssertConfigurationIsValid).ShouldThrow<OpenMapperConfigurationException>();
        ex.Message.ShouldContain("Void .ctor(Dest), parameter foo", Case.Sensitive);
    }
}

public class When_mapping_to_an_object_with_a_constructor_with_a_matching_argument : OpenMapperSpecBase
{
    private Dest _dest;
...
public class When_mapping_to_an_object_with_a_private_constructor : OpenMapperSpecBase
{
    private Dest _dest;
...
public class When_mapping_to_an_object_using_service_location : OpenMapperSpecBase
{
    private Dest _dest;
...
public class When_mapping_to_an_object_using_contextual_service_location : OpenMapperSpecBase
{
    private Dest _dest;
...
public class When_mapping_to_an_object_with_multiple_constructors_and_constructor_mapping_is_disabled : OpenMapperSpecBase
{
    private Dest _dest;
...
public class When_mapping_with_optional_parameters_and_constructor_mapping_is_disabled : OpenMapperSpecBase
{
    public class Destination
    {
...
public class When_configuring_ctor_param_members : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_configuring_nullable_ctor_param_members : OpenMapperSpecBase
{
    public class Source
    {
        public int? Value { get; set; }
...
public class When_configuring_ctor_param_members_without_source_property_1 : OpenMapperSpecBase
{
    public class Source
    {
...
public class When_configuring_ctor_param_members_without_source_property_2 : OpenMapperSpecBase
{
    public class Source
    {
        public string Result { get; }
