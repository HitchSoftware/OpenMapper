...
public class CreateProjectionEnum : OpenMapperSpecBase
{
    public class Source
    {
...
public class InvalidStringToEnum : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(_=> { });
    [Fact]
    public void Should_throw() => new Action(()=>Map<ConsoleColor>("d")).ShouldThrow<OpenMapperMappingException>().InnerException.Message.ShouldBe(
        "Requested value 'd' was not found.");
}
public class DefaultEnumValueToString : OpenMapperSpecBase
{
...
public class StringToNullableEnum : OpenMapperSpecBase
{
    Destination _destination;
...
public class NullableEnumToString : OpenMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_from_a_null_object_with_an_enum : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
...
public class When_mapping_to_a_nullable_flags_enum : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.CreateMap<SourceClass, DestinationClass>();
...
public class When_mapping_from_a_null_object_with_a_nullable_enum : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.AllowNullDestinationValues = false;
...
public class When_mapping_from_a_null_object_with_a_nullable_enum_as_string : OpenMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.CreateMap<SourceClass, DestinationClass>();
...
public class When_the_target_has_an_enummemberattribute_value : OpenMapperSpecBase
{
...
public class When_the_source_has_an_enummemberattribute_value : OpenMapperSpecBase
{
    public enum EnumWithEnumMemberAttribute
    {
        Null,
