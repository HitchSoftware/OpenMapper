namespace OpenMapper.UnitTests.BidirectionalRelationships;

public class RecursiveMappingWithStruct : OpenMapperSpecBase
{
...
public class RecursiveDynamicMapping : OpenMapperSpecBase
{
...
public class When_mapping_to_a_destination_with_a_bidirectional_parent_one_to_many_child_relationship_using_CustomMapper_with_context : OpenMapperSpecBase
{
    private ParentDto _dto;
