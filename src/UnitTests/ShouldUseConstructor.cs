...
public class ShouldUseConstructorInternal : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_only_map_internal_ctor() => Should.Throw<OpenMapperConfigurationException>(AssertConfigurationIsValid);
}
...
public class ShouldUseConstructorPrivate : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_only_map_private_ctor() => Should.Throw<OpenMapperConfigurationException>(AssertConfigurationIsValid);
}
...
public class ShouldUseConstructorPublic : NonValidatingSpecBase
{
    ...
    {
        Should.Throw<OpenMapperConfigurationException>(AssertConfigurationIsValid);
    }
}

public class ShouldUseConstructorDefault : OpenMapperSpecBase
{
    class Destination
    {
        public Destination(int a, string b)
