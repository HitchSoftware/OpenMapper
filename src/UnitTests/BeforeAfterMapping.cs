namespace OpenMapper.UnitTests.BeforeAfterMapping;
...
public class When_using_a_class_to_do_before_after_mappings : OpenMapperSpecBase
{
...
public class When_using_a_class_to_do_before_after_mappings_with_resolutioncontext : OpenMapperSpecBase
{
    private Destination _destination;
...
public class MappingSpecificBeforeMapping : OpenMapperSpecBase
{
    private Dest _dest;
...
public class MappingSpecificAfterMapping : OpenMapperSpecBase
{
    private Dest _dest;
