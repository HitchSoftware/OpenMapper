namespace OpenMapper.UnitTests
{
    namespace Regression
    {
        ...
        public class OpenMapper_fails_to_map_custom_mappings_when_mapping_collections_for_an_interface : OpenMapperSpecBase
        {
        ...
        public class Chris_bennages_nullable_datetime_issue : OpenMapperSpecBase
        {
        ...
        public class TestEnumerable : OpenMapperSpecBase
        {
            protected override MapperConfiguration CreateConfiguration() => new(cfg =>
            {
