namespace OpenMapper.UnitTests.ConditionalMapping;

public class When_adding_a_condition_for_all_members : OpenMapperSpecBase
{
...
public class When_ignoring_all_properties_with_an_inaccessible_setter_and_explicitly_implemented_member : OpenMapperSpecBase
{
...
public class When_configuring_a_member_to_skip_based_on_the_property_value : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_configuring_a_member_to_skip_based_on_the_property_value_with_custom_mapping : OpenMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_configuring_a_map_to_ignore_all_properties_with_an_inaccessible_setter : OpenMapperSpecBase
{
...
public class When_configuring_a_reverse_map_to_ignore_all_source_properties_with_an_inaccessible_setter : OpenMapperSpecBase
{
    private Destination _destination;
