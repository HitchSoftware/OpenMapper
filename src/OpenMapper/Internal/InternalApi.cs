using OpenMapper.Configuration.Conventions;
using OpenMapper.Features;
using OpenMapper.Internal.Mappers;
using OpenMapper.QueryableExtensions.Impl;

namespace OpenMapper.Internal;
...
public interface IGlobalConfigurationExpression : IMapperConfigurationExpression, IProfileExpressionInternal
{
    ...
    /// <summary>
    /// How many levels deep should OpenMapper try to inline the execution plan for child classes.
    /// See <a href="https://OpenMapper.readthedocs.io/en/latest/Understanding-your-mapping.html">the docs</a> for details.
    /// </summary>
...
public interface IGlobalConfiguration : IConfigurationProvider
{
    ...
    /// See <a href="https://OpenMapper.readthedocs.io/en/latest/Understanding-your-mapping.html">the wiki</a> for details.
    /// </summary>
...
public interface IProfileExpressionInternal : IProfileExpression
{
    ...
    /// <summary>
    /// Disable method mapping. Use this if you don't intend to have OpenMapper try to map from methods.
    /// </summary>
    bool? MethodMappingEnabled { get; set; }
    /// <summary>
    /// Disable fields mapping. Use this if you don't intend to have OpenMapper try to map from/to fields.
    /// </summary>
