namespace OpenMapper.Configuration.Annotations;

/// <summary>
/// Specify the source member to map from. Can only reference a member on the <see cref="OpenMapAttribute.SourceType" /> type
/// </summary>
/// <remarks>
/// Must be used in combination with <see cref="OpenMapAttribute" />
/// </remarks>
