...
namespace OpenMapper.Extensions.Microsoft.DependencyInjection.Tests.Integrations
{
	public class ServiceLifetimeTests
	{
		...
		public void CanUseDefaultInjectedIMapperInSingletonService()
		{
			...
			services.AddOpenMapper(cfg => cfg.CreateMap<Foo, Bar>().ReverseMap(), GetType().Assembly);
