...
Please start a discussion on the [core repo issue tracker](https://github.com/OpenMapper/OpenMapper/issues).

## Platform
OpenMapper is built using the RTM tooling that ships with the latest Visual Studio. This is the only configuration accepted.
...
* [Core](https://github.com/OpenMapper/OpenMapper)
* [EF6 Extensions](https://github.com/OpenMapper/OpenMapper.EF6)
* [IDataReader/Record Extensions](https://github.com/OpenMapper/OpenMapper.Data)
* [Collection Extensions](https://github.com/OpenMapper/OpenMapper.Collection)
* [Microsoft DI Extensions](https://github.com/OpenMapper/OpenMapper.Extensions.Microsoft.DependencyInjection)

## Other discussions
https://gitter.im/OpenMapper/OpenMapper
...
1. Did you read the [documentation](https://OpenMapper.readthedocs.io/en/latest/)?
